...
public interface CorteCrudRepository extends CrudRepository<Corte,Integer> {
    ...
    @Query(value = "SELECT idcorte, dinerocaja, dinerocajacorte, comentario, horaentrada, horasalida FROM public.corte where horaentrada::TIMESTAMP::DATE = :fecha;", nativeQuery = true)
